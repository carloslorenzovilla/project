...
Revision ID: ab559f2ef1cb
Revises: 
Create Date: 2020-04-16 12:52:13.392841
...
def upgrade():
    ...
    op.create_index(op.f('ix_locations_neighborhood'), 'locations', ['neighborhood'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_locations_neighborhood'), table_name='locations')
